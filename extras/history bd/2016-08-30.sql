...
CREATE TABLE IF NOT EXISTS `depuracion` (
  ...
  `Fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=313 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla bienestarcun.depuracion: ~4 rows (aproximadamente)
...
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	...
	(303, 'Error desde php #!# Error: Undefined variable: dataEnd#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidlaboralsaveNewLaboralHistory.php#!#linea: 33#!#', '2016-08-30 15:33:43'),
	(304, 'Error desde android #!# Funcion: SearchChatPendientes #!#Clase : ChatPsicologiaManager.java #!#null', '2016-08-30 16:32:38'),
	(305, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20160830_215002.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 16:50:06'),
	(306, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20160830_215201.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 16:52:04'),
	(307, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20160830_215232.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 16:52:35'),
	(308, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20160830_220259.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 17:03:01'),
	(309, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20160830_220302.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 17:03:04'),
	(310, 'Error desde android #!# Funcion: getNameUser try 1 #!#Clase : GeneralCode.java #!#null', '2016-08-30 17:08:16'),
	(311, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/Evidencia#!#14#!#20160830_171125.jpg: open failed: ENOENT (No such file or directory)', '2016-08-30 17:11:45'),
	(312, 'Error desde php #!# Error: chmod(): No such file or directory#!#Tipo: 2#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCircleSaveEvidencia.php#!#linea: 18#!#', '2016-08-30 17:12:08');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los registros hechos por los docente por estudiantes en ausencia prolongada con posible desercion';
...
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';
...
INSERT INTO `logs` (`Id`, `Fecha`, `Usuario`, `Token`, `Estado`) VALUES
	...
	(106, '2016-07-29 22:47:55', 1104379, '1a25fef28b3a6302a6838a7b5b8612f160238cba', 0),
	...
	(109, '2016-08-30 16:21:16', 7, 'b3bb97f02abda62497a5767ce4ea52a19aad2b22', 1),
	(110, '2016-08-30 17:10:59', 1104379, '560babf05c4f62c2846d5c69d68e1e456f5dd1e2', 1);
