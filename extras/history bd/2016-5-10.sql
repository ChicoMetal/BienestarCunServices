...
INSERT INTO `asistencias` (`id`, `Presencia`, `Fecha`, `Usuario`, `Itinerario`) VALUES
	(7, '111', '2015-12-07 15:41:15', 1104379, 10),
	(8, '111', '2015-12-07 15:41:15', 8, 10);
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los mensajes dirijidos a la psicologa';

-- Volcando datos para la tabla bienestarcun.chatpsicologia: ~17 rows (aproximadamente)
...
INSERT INTO `chatpsicologia` (`Id`, `Mensaje`, `Fecha`, `Estado`, `Remitente`, `Destinatario`) VALUES
	(109, 'hola', '2015-11-27 04:14:52', 1, 1104379, 7),
	(110, 'Hola', '2015-11-27 04:15:39', 1, 7, 1104379),
	(111, 'Hola', '2015-11-27 04:15:48', 1, 7, 1104379),
	(112, 'como esta', '2015-11-27 04:16:22', 1, 1104379, 7),
	(113, 'Bien', '2015-11-27 04:16:31', 1, 7, 1104379),
	(114, 'Y usted', '2015-11-27 04:17:08', 1, 7, 1104379),
	(115, 'bn gracias', '2015-11-27 04:17:15', 1, 1104379, 7),
	(116, 'lo que sucede es que me siento muy triste y tengo ganas de salir corriendo gritando locuras por la c', '2015-11-27 04:18:03', 1, 1104379, 7),
	(117, 'Cu', '2015-11-27 04:19:28', 1, 7, 1104379),
	(118, 'hola', '2015-11-27 04:21:58', 1, 1104379, 7),
	(119, 'Hola', '2015-11-27 04:22:28', 1, 7, 1104379),
	(120, 'como esta', '2015-11-27 04:22:41', 1, 1104379, 7),
	(121, 'Bien y usted', '2015-11-27 04:23:01', 1, 7, 1104379),
	(122, 'bn gracias', '2015-11-27 04:23:12', 0, 1104379, 7),
	(123, 'Hola, puede ayudarme', '2015-11-27 05:40:44', 0, 5, 7),
	(124, 'hola', '2015-12-01 16:21:43', 0, 1104379, 7),
	(125, 'Hi', '2015-12-09 19:41:11', 0, 4, 7);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran aquellas actividades o eventos que requieran identificar un grupo de usuarios especificos, como las actividades de musica, danza, futbol etc';

-- Volcando datos para la tabla bienestarcun.circulos: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `circulos` DISABLE KEYS */;
INSERT INTO `circulos` (`id`, `Nombre`, `Descripcion`, `Estado`, `Admin`) VALUES
	(1, 'Musica', 'Actividad de canto, guitarra, bajo', 1, 1104379),
	(2, 'Danza', 'Aprendizaje de bailes folcloricos, modernos, cumbia etc', 1, 1104379),
	(3, 'Football', 'Deporte de juego de equipo en micro', 1, 1104379),
	(4, 'Publico', 'Las notificaciones de este circulo estaran abiertas a todos los que tengan la app instalada', 1, NULL),
	(5, 'Psicologa', 'Las notificaciones de este circulo podran ser vistas por usuario de psicologia', 1, NULL),
	(6, 'Egresados', 'Las notificaciones de este circulo podran ser vistas por estudiantes egresados', 1, NULL),
	(7, 'Estudiantes', 'Las notificaciones de este circulo podran ser vistas por estudiantes', 1, NULL),
	(8, 'Docentes', 'Las notificaciones de este circulo podran ser vistas por los docentes', 1, NULL),
	(9, 'Tutores bienestar', 'Las notificaciones de este circulo podran ser vistas por los tutores del area de bienestar', 1, NULL);
...
CREATE TABLE IF NOT EXISTS `depuracion` (
  ...
  `Fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=246 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla bienestarcun.depuracion: ~21 rows (aproximadamente)
/*!40000 ALTER TABLE `depuracion` DISABLE KEYS */;
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	(225, 'Error desde php #!# Error: Trying to get property of non-object#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 23#!#', '2015-12-07 00:08:47'),
	(226, 'Error desde php #!# Error: Trying to get property of non-object#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 23#!#', '2015-12-07 00:08:48'),
	(227, 'Error desde php #!# Error: Trying to get property of non-object#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 22#!#', '2015-12-07 00:09:15'),
	(228, 'Error desde php #!# Error: Cannot use object of type stdClass as array#!#Tipo: 1#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 22#!#', '2015-12-07 00:10:05'),
	(229, 'Error desde php #!# Error: Object of class stdClass could not be converted to string#!#Tipo: 4096#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 24#!#', '2015-12-07 00:12:21'),
	(230, 'Error desde php #!# Error: Undefined variable: sqlInsert#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 30#!#', '2015-12-07 00:13:29'),
	(231, 'Error desde php #!# Error: Undefined variable: sqlInsert#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 30#!#', '2015-12-07 00:13:30'),
	(232, 'Error desde php #!# Error: Undefined variable: sqlInsert#!#Tipo: 8#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/saveListAsitencia.php#!#linea: 32#!#', '2015-12-07 00:14:14'),
	(233, 'Error desde php #!# Error: chmod(): No existe el archivo o el directorio#!#Tipo: 2#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/SaveEvidencia.php#!#linea: 17#!#', '2015-12-08 23:20:13'),
	(234, 'Error desde php #!# Error: chmod(): No existe el archivo o el directorio#!#Tipo: 2#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/SaveEvidencia.php#!#linea: 17#!#', '2015-12-08 23:27:04'),
	(235, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T200902America/Bogota(2,341,-18000,0,1449623342)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:09:56'),
	(236, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201000America/Bogota(2,341,-18000,0,1449623400)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:11:19'),
	(237, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201158America/Bogota(2,341,-18000,0,1449623518)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:12:54'),
	(238, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201425America/Bogota(2,341,-18000,0,1449623665)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:15:29'),
	(239, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201551America/Bogota(2,341,-18000,0,1449623751)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:18:16'),
	(240, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201934America/Bogota(2,341,-18000,0,1449623974)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:19:43'),
	(241, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/10#!#20151208T201934America/Bogota(2,341,-18000,0,1449623974)#!#Evidencia.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:19:43'),
	(242, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/Evidencia#!#10#!#20151208_202409.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:24:39'),
	(243, 'Error desde android #!# Funcion: onActivityResult(try 1 get image FileNotFoundException) #!#Clase : MainActivity.java #!#/storage/sdcard0/Evidencia#!#10#!#20151208_202409.jpg: open failed: ENOENT (No such file or directory)', '2015-12-09 01:24:43'),
	(244, 'Error desde php #!# Error: chmod(): No existe el archivo o el directorio#!#Tipo: 2#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/SaveEvidencia.php#!#linea: 17#!#', '2015-12-09 01:28:26'),
	(245, 'Error desde php #!# Error: chmod(): No existe el archivo o el directorio#!#Tipo: 2#!#Archivo: /opt/lampp/htdocs/BienestarCun/core/android/adminCircle/SaveEvidencia.php#!#linea: 17#!#', '2015-12-09 01:30:09');
...
INSERT INTO `desercion` (`id`, `Jornada`, `Fecha`, `Estado`, `Desertor`, `Usuario`) VALUES
	(1, 'Nocturno', '2015-11-30 18:02:58', 0, 1104379, 1104379),
	(2, 'Diurno', '2015-11-30 18:05:19', 0, 1104379, 1104379),
	(6, 'Nocturno', '2015-11-30 18:41:19', 0, 1104379, 1104379),
	(7, 'Nocturno', '2015-11-30 18:47:13', 0, 1104379, 1104379),
	(8, 'Nocturno', '2015-12-01 15:54:31', 0, 1104379, 1104379);
...
CREATE TABLE IF NOT EXISTS `itinerarios` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran el itinerario de cada uno de los circulos, como las clases que se llevaran a cabo.';

-- Volcando datos para la tabla bienestarcun.itinerarios: ~13 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';

-- Volcando datos para la tabla bienestarcun.logs: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
INSERT INTO `logs` (`Id`, `Fecha`, `Usuario`, `Token`, `Estado`) VALUES
	(87, '2015-12-04 04:17:25', 1104379, '7a2d82b06003e1980d52e9f51ae060bec914de2f', 0),
	(88, '2015-12-04 04:32:08', 1104379, '8c7ec2300fc774ce76054d441c27b6ccc4d88052', 0),
	(89, '2015-12-04 04:32:53', 1104379, '9254ed07993084fed57c03aff3f1db52652c41fd', 1),
	(90, '2015-12-04 17:55:27', 1104379, '3a2e3e7760658b850d176405052c0dddcc83c3f0', 1),
	(91, '2015-12-09 19:40:36', 4, '9c0186f769438bb44da2ab083e2b9bc58fdf3942', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los intentos fallidos en el proceso de login ';

-- Volcando datos para la tabla bienestarcun.logsfails: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `logsfails` DISABLE KEYS */;
INSERT INTO `logsfails` (`Id`, `User`, `Password`, `Fecha`, `Usuario`) VALUES
	(41, '1104379', 'hh', '2015-12-04 04:17:13', 1104379),
	(42, '1104379214', '8', '2015-12-04 04:31:58', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Mensajes creados por el o los administradores del circulo, para los usuarios inscritos al circulo';
...
-- Volcando datos para la tabla bienestarcun.personas: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `personas` DISABLE KEYS */;
INSERT INTO `personas` (`Identificacion`, `TipoId`, `Nombres`, `Apellidos`, `#Contacto`, `Email`, `Direccion`, `Sexo`, `Edad`, `Sede`) VALUES
	(2, 'cc', 'asd', 'asdasd', '222', 'adasd', 'sdads', 'M', 12, 1),
	(3, 'CC', 'fff', 'ssss', '222', 'dddd', 'dddd', 'M', 23, 1),
	(4, 'cc', 'dddd', 'dddd', '2233', 'dsd', 'adsasd', 'M', 23, 1),
	(5, 'CC', 'adsas', 'sads', '3424', 'dfsf', 'sfsdf', 'M', 23, 1),
	(6, 'cc', 'dasd', 'agdfg', '3243', 'dfsdf', 'fsdfdf', 'M', 25, 1),
	(7, 'cc', 'asds', 'ghghg', '4544', 'fdgdfg', 'fgdg', 'M', 23, 1),
	(8, 'cc', 'fsdfsd', 'ssfsdf', '23423', 'dffsdfd', 'sdfsf', 'M', 34, 1),
	(41, 'cc', '41', 'DOCENTE', '3434434', 'sdfdf@dfdf', 'sincelejo', 'M', 35, 1),
...
CREATE TABLE IF NOT EXISTS `sede` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se registran la diferentes sedes de la universidad';

-- Volcando datos para la tabla bienestarcun.sede: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran las relaciones entre los usuario y los circulos a los que pertenecen';

-- Volcando datos para la tabla bienestarcun.usuariocirculo: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.usuarios: ~0 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `User`, `Password`, `Tipo`, `Estado`) VALUES
	...
	(8, '8', '1', '1000', '1'),
	(41, '41', '41', '1100', '1'),
	(1104379, '1104379', '8', '1111', '1');
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;


-- Volcando estructura para procedimiento bienestarcun.VincularUsuarioCircleDefault
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `VincularUsuarioCircleDefault`(tipoUsuario VARCHAR(10), idUsuario BIGINT(15) )
BEGIN 
	...
	IF tipoUsuario = '1000' THEN    
		...
		SELECT Id INTO idCircle  FROM circulos WHERE Nombre LIKE '%Publico%' LIMIT 1 ;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);   

	ELSEIF tipoUsuario = '1001' THEN      

		SELECT Id INTO idCircle FROM circulos WHERE Nombre LIKE '%Psicologa%' LIMIT 1;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);

		SELECT Id INTO idCirclePublic  FROM circulos WHERE Nombre LIKE '%Publico%' LIMIT 1 ;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCirclePublic);

	ELSEIF tipoUsuario = '1010' THEN    

		SELECT Id INTO idCircle FROM circulos WHERE Nombre LIKE '%Egresados%' LIMIT 1;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);
	...
	ELSEIF tipoUsuario = '1011' THEN   
		...
		SELECT Id INTO idCircle FROM circulos WHERE Nombre LIKE '%Estudiantes%' LIMIT 1;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);  
	...
	ELSEIF tipoUsuario = '1100' THEN     
		...
		SELECT Id INTO idCircle FROM circulos WHERE Nombre LIKE '%Docentes%' LIMIT 1;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);
	...
	ELSEIF tipoUsuario = '1101' THEN   
		...
		SELECT Id INTO idCircle FROM circulos WHERE Nombre LIKE '%Tutores bienestar%' LIMIT 1;
		INSERT INTO usuariocirculo(Usuario, Circulo) VALUES(idUsuario, idCircle);
