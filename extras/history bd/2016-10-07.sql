...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenara el listado de las asistencias o inasistencia de los estudiantes a los itinerarios';

-- Volcando datos para la tabla bienestarcun.asistencias: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los mensajes dirijidos a la psicologa';
...
-- Volcando datos para la tabla bienestarcun.depuracion: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `depuracion` DISABLE KEYS */;
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	(786, 'Error desde android #!# Funcion: onActivityResult #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.MainActivity.java #!#/storage/emulated/0/Evidencia#!#14#!#20161005_225222.jpg: open failed: ENOENT (No such file or directory)', '2016-10-05 17:52:25'),
	(787, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-10-05 17:52:25'),
	(788, 'Error desde php #!# Error: chmod(): No such file or directory#!#Tipo: 2#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCircleSaveEvidencia.php#!#linea: 18#!#', '2016-10-06 20:35:33'),
	(789, 'Error desde php #!# Error: chmod(): No such file or directory#!#Tipo: 2#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCircleSaveEvidencia.php#!#linea: 18#!#', '2016-10-06 20:37:05'),
	(790, 'Error desde php #!# Error: Maximum execution time of 30 seconds exceeded#!#Tipo: 1#!#Archivo: C:xampphtdocsBienestarCuncoreandroidcirclesGetCirclesExists.php#!#linea: 29#!#', '2016-10-06 21:37:25'),
	(791, 'Error desde php #!# Error: Maximum execution time of 30 seconds exceeded#!#Tipo: 1#!#Archivo: C:xampphtdocsBienestarCuncoreandroidcirclesGetCirclesExists.php#!#linea: 29#!#', '2016-10-06 21:40:55'),
	(792, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione una facultad', '2016-10-06 22:49:44'),
	(793, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-10-06 22:49:44'),
	(794, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-06 23:31:32'),
	(795, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-06 23:49:25'),
	(796, 'Error desde php #!# Error: chmod(): No such file or directory#!#Tipo: 2#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCircleSaveEvidencia.php#!#linea: 18#!#', '2016-10-06 23:58:13'),
	(797, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-07 00:04:33'),
	(798, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-07 00:05:25'),
	(799, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-07 00:05:36'),
	(800, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidchatPsicologiagetMensajes.php#!#linea: 36#!#', '2016-10-07 00:10:29');
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los registros hechos por los docente por estudiantes en ausencia prolongada con posible desercion';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran la informacion de los archivos subidos por los administradores de los circulos, ubicacion, nombre del archivo etc.';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se va almacenando los historiales laborales de los egresados, empleos que ha tenido, lugar donde labora actualmente etc.';
...
INSERT INTO `historiallaboral` (`Id`, `Empresa`, `Cargo`, `FechaInicio`, `FechaFin`, `LaboralEgresado`) VALUES
	...
	(44, 'ott', 'auxiliar en sistemas', '2013-01-07', '2015-11-12', 1104379);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran el itinerario de cada uno de los circulos, como las clases que se llevaran a cabo.';
...
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';
...
INSERT INTO `logs` (`Id`, `Fecha`, `Usuario`, `Token`, `Estado`) VALUES
	...
	(142, '2016-10-07 00:03:57', 7, '30b83c2fd687ee37c76cedce57296113bf86a412', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Mensajes creados por el o los administradores del circulo, para los usuarios inscritos al circulo';
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran las relaciones entre los usuario y los circulos a los que pertenecen';
