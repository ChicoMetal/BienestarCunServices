...
-- Volcando datos para la tabla bienestarcun.depuracion: ~17 rows (aproximadamente)
...
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	...
	(101, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 15:49:26'),
	(102, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 15:59:04'),
	(103, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 15:59:13'),
	(104, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 15:59:14'),
	(105, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 15:59:17'),
	(106, 'Error desde php #!# Error: Object of class stdClass could not be converted to string#!#Tipo: 4096#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 15:59:24'),
	(107, 'Error desde php #!# Error: Undefined index: Tipo#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 16:00:53'),
	(108, 'Error desde php #!# Error: Undefined index: Tipo#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 30#!#', '2016-09-29 16:01:13'),
	(109, 'Error desde php #!# Error: Undefined offset: 1#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 31#!#', '2016-09-29 16:11:49'),
	(110, 'Error desde php #!# Error: Undefined offset: 1#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroid\notificationsgetNotifications.php#!#linea: 31#!#', '2016-09-29 16:11:58'),
	(111, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCirclesaveNewItinerario.php#!#linea: 35#!#', '2016-09-29 16:37:25'),
	(112, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidadminCirclesaveNewItinerario.php#!#linea: 39#!#', '2016-09-29 16:42:19'),
	(113, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:50:58'),
	(114, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:50:58'),
	(115, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:52:12'),
	(116, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:52:12'),
	(117, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:52:36'),
	(118, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:52:36'),
	(119, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:53:37'),
	(120, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:53:37'),
	(121, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:53:43'),
	(122, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:53:43'),
	(123, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:53:51'),
	(124, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:53:51'),
	(125, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:54:37'),
	(126, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:54:37'),
	(127, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:56:11'),
	(128, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:56:11'),
	(129, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-29 23:59:31'),
	(130, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-29 23:59:31'),
	(131, 'Error desde android #!# Funcion: ValidateResponse #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#Index 1 out of range [0..1)', '2016-09-30 00:00:51'),
	(132, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 00:00:51'),
	(133, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroiddesertionsaveDesertion.php#!#linea: 26#!#', '2016-09-30 00:34:05'),
	(134, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione', '2016-09-30 00:49:33'),
	(135, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 00:49:33'),
	(136, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione', '2016-09-30 00:51:39'),
	(137, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 00:51:39'),
	(138, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione', '2016-09-30 00:53:42'),
	(139, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 00:53:42'),
	(140, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione', '2016-09-30 00:56:57'),
	(141, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 00:56:57'),
	(142, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Seleccione', '2016-09-30 01:00:35'),
	(143, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 01:00:36'),
	(144, 'Error desde android #!# Funcion: onClick #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Desertion_app.java #!#No value for Selecciones una facultad', '2016-09-30 01:02:52'),
	(145, 'Error desde php #!# Error: Array to string conversion#!#Tipo: 8#!#Archivo: C:xampphtdocsBienestarCuncoreandroidsaveFatalError.php#!#linea: 20#!#', '2016-09-30 01:02:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran el itinerario de cada uno de los circulos, como las clases que se llevaran a cabo.';

-- Volcando datos para la tabla bienestarcun.itinerarios: ~19 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=139 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';

-- Volcando datos para la tabla bienestarcun.logs: ~13 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.logsfails: ~5 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Mensajes creados por el o los administradores del circulo, para los usuarios inscritos al circulo';

-- Volcando datos para la tabla bienestarcun.notificaciones: ~22 rows (aproximadamente)
