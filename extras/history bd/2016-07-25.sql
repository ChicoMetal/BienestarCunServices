...
) ENGINE=InnoDB AUTO_INCREMENT=329 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los mensajes dirijidos a la psicologa';
...
INSERT INTO `chatpsicologia` (`Id`, `Mensaje`, `Fecha`, `Estado`, `Remitente`, `Destinatario`) VALUES
	...
	(326, 'hi', '2016-07-11 18:14:47', 0, 1104379, 7),
	(327, 'oe', '2016-07-11 18:14:57', 0, 7, 1104379),
	(328, 'q mas ve', '2016-07-11 18:15:40', 0, 7, 1104379);
...
CREATE TABLE IF NOT EXISTS `depuracion` (
  ...
  `Fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=293 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	...
	(284, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 14:41:21'),
	(285, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 14:41:27'),
	(286, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 14:51:17'),
	(287, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 14:51:19'),
	(288, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 15:06:11'),
	(289, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 15:06:13'),
	(290, 'Error desde android #!# Funcion: SearchItinerarios #!#Clase : ItinerariosManager.java #!#Value msm at 0 of type java.lang.String cannot be converted to JSONArray', '2016-07-14 15:08:05'),
	(291, 'Error desde android #!# Funcion: onCreate #!#Clase : MainActivity.java #!#println needs a message', '2016-07-25 17:44:38'),
	(292, 'Error desde android #!# Funcion: onCreate #!#Clase : MainActivity.java #!#println needs a message', '2016-07-25 17:48:45');
...
-- Volcando datos para la tabla bienestarcun.itinerarios: ~8 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';
