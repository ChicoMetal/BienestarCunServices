...
INSERT INTO `circulos` (`id`, `Nombre`, `Descripcion`, `Estado`, `Admin`, `Sede`) VALUES
	...
	(2, 'Danza', 'Aprendizaje de bailes folcloricos, modernos, cumbia etc', 1, 1104379, 1),
	(3, 'Football', 'Deporte de juego de equipo en micro', 1, 1104379, 1),
...
CREATE TABLE IF NOT EXISTS `depuracion` (
  ...
  `Fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=275 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla bienestarcun.depuracion: ~49 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';

-- Volcando datos para la tabla bienestarcun.logs: ~12 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.personas: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.usuariocirculo: ~13 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.usuarios: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `User`, `Password`, `Tipo`, `Estado`) VALUES
	(2, '2', 'admin', '1110', '1'),
	(3, '3', 'acircle', '1101', '1'),
	(4, '4', 'docente', '1100', '1'),
	(5, '6', 'estudiante', '1011', '1'),
	(6, '7', 'egresado', '1010', '1'),
	(7, '5', 'psicologa', '1001', '1'),
	(8, '9', '1', '1000', '1'),
	(41, '8', '41', '1100', '1'),
	(1104379, '1', 'sadmin', '1111', '1');
