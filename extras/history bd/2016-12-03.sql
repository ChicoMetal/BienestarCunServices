...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran todos los movimientos realizados en la base de datos y el usuario que lo realizo';

-- Volcando datos para la tabla bienestarcun.auditoria: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla bienestarcun.depuracion: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `depuracion` DISABLE KEYS */;
INSERT INTO `depuracion` (`Id`, `Contenido`, `Fecha`) VALUES
	(16, 'Error desde android #!# Funcion: PrepareAdapter #!#Clase : com.co.edu.cun.www1104379214.bienestarcun.ui.frragmentContent.Show_itinerario_circle.java #!#Dispositivo :( BOARD: MSM8974 #!#BOOTLOADER: s1 #!#BRAND: Sony #!#DEVICE: D5803 #!#DISPLAY: 23.5.A.1.291 #!#FINGERPRINT: Sony/D5803/D5803:6.0.1/23.5.A.1.291/2769308465:user/release-keys #!#HARDWARE: qcom #!#HOST: BuildHost #!#MODEL: D5803 #!#PRODUCT: D5803 #!#SERIAL: YT9111G5YE #!#) #!#Attempt to invoke virtual method \\\'android.content.res.Resources$Theme android.content.Context.getTheme()\\\' on a null object reference', '2016-12-03 02:06:26');
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran los registros hechos por los docente por estudiantes en ausencia prolongada con posible desercion';
...
-- Volcando datos para la tabla bienestarcun.evidencias: ~5 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se va almacenando los historiales laborales de los egresados, empleos que ha tenido, lugar donde labora actualmente etc.';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran el itinerario de cada uno de los circulos, como las clases que se llevaran a cabo.';

-- Volcando datos para la tabla bienestarcun.itinerarios: ~17 rows (aproximadamente)
...
INSERT INTO `laboralegresado` (`Id`, `Laborando`, `FechaCreate`, `FechaUpdate`) VALUES
	...
	(1104379, 0, '2016-10-20 23:38:13', '2016-12-03 01:31:16');
...
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena el historial de logs por los usuarios';
...
INSERT INTO `logs` (`Id`, `Fecha`, `Cerrada`, `Usuario`, `Token`, `Estado`) VALUES
	...
	(193, '2016-12-03 01:30:53', '2016-12-03 01:30:53', 1104379, '5bba30778b874c29d0ec47118ce08a0ec65617df', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Mensajes creados por el o los administradores del circulo, para los usuarios inscritos al circulo';

-- Volcando datos para la tabla bienestarcun.notificaciones: ~38 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacenaran las relaciones entre los usuario y los circulos a los que pertenecen';

-- Volcando datos para la tabla bienestarcun.usuariocirculo: ~24 rows (aproximadamente)
